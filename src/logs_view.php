 ...
 */
        ...
        *,
        ...
        .sidebar .nav-link.active .log-file-size {
            color: #16a34a;
        }
        ...
        /* Log line limiting and expansion styles */
        .log-message {
            max-width: 600px;
            white-space: nowrap;
            overflow: hidden;
...
<body>
                            ...
                            <table id="indexScreen" class="table table-hover table-sm mb-0 penultimate-column-right <?=empty($logs) ? 'd-none': ''?>">
                                ...
                                <tbody id="logData">
                                    <?php foreach ($logs as $key => $log) : ?>
                                        <tr class="log-row" data-log-id="<?=$key?>">
                                            <td class="table-fit">
                                                <span class="badge font-weight-light <?= strtolower($log['level']) == 'error' || strtolower($log['level']) == 'fatal' ? 'badge-danger' : 'badge-info' ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Add click functionality for log rows to expand/collapse details
            $(document).on('click', '.log-row', function (e) {
                ...
                if ($row.hasClass('expanded')) {
                    ...
                    $('.log-row.expanded').removeClass('expanded');
                    $('.log-details').hide();
